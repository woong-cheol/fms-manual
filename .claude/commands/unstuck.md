---
description: USE WHEN stuck on a bug, architecture decision, or recurring failure. Applies 5 perspectives sequentially (Researcher → Simplifier → Contrarian → Hacker → Architect) to break deadlock.
---

# /unstuck — 막혔을 때 돌파구 찾기
